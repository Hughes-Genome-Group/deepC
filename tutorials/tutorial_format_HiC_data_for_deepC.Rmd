...
The tutorial walks through formating a single chromosomes. In practice we prepare each 
...
```{r}
  ...
  write.table(bdf, file = paste0("coords_and_hic_skeleton_for_deepC_5kb_", chrom,".bed"),
