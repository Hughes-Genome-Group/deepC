...
setwd("~/Data/machine_learning/deepC_write_tutorials_offline/run_deepc_tutorial/")
...
# actually run
python ../deepC/current_version/run_deploy_shape_deepCregr.py --input example_region_short.bed \
...
```{bash, eval=FALSE}
# Run in terminal
python ../deepC/current_version/run_deploy_shape_deepCregr.py --input example_variant.bed \
